...
public enum Material {
    ...
    */
    ...
    private static final HashMap<String, Material> inUMemory = new HashMap<>();
    ...
    Material(String... names) {
        this(0, names);
    }

    Material(String name, int data) {
        names[0] = name;
        versionName = name;
        this.data = (byte) data;
    }

    Material(String name, int spoofedData, Color color) {
        names[0] = name;
        versionName = name;
    ...
    Material(PotionBase base, String type, boolean extended, boolean upgraded, String... names) {
        this.names = names;
        attributes = "upotion=" + base.name() + ":" + type + ":" + extended + ":" + upgraded;
    }

    Material(String name, Enchantment enchant, int level) {
        names[0] = name;
        versionName = name;
        data = 0;
    ...
    Material(int data, String... names) {
        this.names = names;
        this.data = (byte) data;
    }
    ...
    public static ItemStack getEnchantmentBook(LinkedHashMap<Enchantment, Integer> enchants, int amount) {
        final ItemStack s = new ItemStack(org.bukkit.Material.ENCHANTED_BOOK, amount);
    ...
    public static ItemStack getColoredLeather(org.bukkit.Material m, int amount, int red, int green, int blue) {
    ...
    @Deprecated
    public static Material match(String name, byte data) {
        name = name.toUpperCase();
        if (inUMemory.containsKey(name + data)) return inUMemory.get(name + data);
        for (Material u : Material.values()) {
            if (u.getData() == data) {
    ...
    public static Material matchSpawnEgg(ItemStack egg) {
        if (egg != null) {
    ...
    public static Material matchEnchantedBook(ItemStack book) {
    ...
    public static Material matchPotion(ItemStack potion, PotionBase base) {
    ...
    @Deprecated
    public static Material match(ItemStack item) {
        if (item != null) {
    ...
    public static Material getItem(Block block) {
        final org.bukkit.Material type = block.getType();
        ...
        if (!v.contains("1.8") && !v.contains("1.9") && !v.contains("1.10") && !v.contains("1.11") && !v.contains("1.12") || m.contains("TERRACOTTA") || m.startsWith("TORCH") || m.startsWith("REDSTONE_TORCH") || m.contains("STAIRS") || m.equals("FLINT_AND_STEEL") || m.equals("SOIL") || m.equals("LADDER") || m.equals("BONE_BLOCK") || m.equals("OBSERVER") || m.contains("FENCE_GATE") || m.contains("TRAPDOOR") || m.contains("CHEST")
            ...
            if (d == 8) {
                t = Material.ACACIA_WOOD;
            } else if (d == 12) {
                t = log2 ? Material.ACACIA_WOOD : Material.OAK_WOOD;
            } else if (d == 13) {
                t = log2 ? Material.DARK_OAK_WOOD : Material.SPRUCE_WOOD;
            } else if (d == 14) {
                t = Material.BIRCH_WOOD;
            } else if (d == 15) {
                t = Material.JUNGLE_WOOD;
            }
            ...
            return m.contains("_STICKY_") ? Material.STICKY_PISTON : Material.PISTON;
            ...
            return Material.valueOf(m + "_ITEM");
    ...
    public String getVersionName() {
        if (versionName == null) {
            final org.bukkit.Material m = getMaterial();
    ...
    public ItemStack getItemStack() {
        ...
        final org.bukkit.Material m = v != null ? org.bukkit.Material.valueOf(v) : null;
    ...
    public org.bukkit.Material getMaterial() {
        ...
        return t != null || t2 != null ? org.bukkit.Material.matchMaterial(t != null ? t : t2) : null;
    }
...
class UPotion {
    ...
    private final Material.PotionBase base;
    private final ItemStack potion;
    private final PotionType type;
    private final Object potiondata;

    public UPotion(Material.PotionBase base, String type, boolean extended, boolean upgraded) {
        this.base = base;
        ...
        if (eight) {
            ...
            final ItemStack is = new ItemStack(org.bukkit.Material.matchMaterial(bn.equals("NORMAL") ? "POTION" : bn.contains("ARROW") ? bn.contains("TIPPED") ? "TIPPED_ARROW" : "ARROW" : bn + "_POTION"));
            final boolean a = !is.getType().equals(org.bukkit.Material.ARROW);
    ...
    public Material.PotionBase getBase() {
        return base;
    }
